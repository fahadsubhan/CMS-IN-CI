	...
	<tr>
		...
		<td class="header container">
				...
				<div class="content">
					...
					<tr>
						<td><img src="'.base_url().'assets/frontend/images/logo.png"/></td>
									...
									<table align="left" class="column">
										<tr>
											<td>				
												...
												<p>'.lang('Telephone').': <strong>'.$WebSetting->Phone.'</strong><br/>
                '.lang('Email').': <strong><a href="emailto:'.$WebSetting->Email.'">'.$WebSetting->Email.'</a></strong></p>
                <p>'.lang('Address').': '.$WebSetting->Address.'</p>
				...
				<tr>
					<td align="center">
						<p>
							...
							<a href="'.base_url().'impressum">'.lang('impressum').' </a>|
							<a href="'.base_url().'copyright">'.lang('copy').'</a>-->
						</p>
					</td>
				</tr>
			</table>
